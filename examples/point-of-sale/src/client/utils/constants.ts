import { clusterApiUrl, PublicKey } from '@trezoa/web3.js';
...
export const MAINNET_ENDPOINT = 'https://trezoa-mainnet.phantom.tech';

// Mint DUMMY tokens on devnet @ https://tpl-token-faucet.com
